...
function runServe(){
  ...
  if ( getIonicVsn() >= 2 ) {
    var child = exec('npm run mobilecaddy cors', {async:true});
...
function runDeploy(){
  ...
  replaceHtmlTitles(packageJson.name).then(function() {
    ...
    // TODO Rename fonts files to uppercase (maybe)

    // TODO Remove querystring from Ionicons woff2 links (maybe)

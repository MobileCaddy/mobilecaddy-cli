...
switch (mainOptions.command) {
  case 'monitor':
    const monitorDefinitions = [{ name: 'username', alias: 'u', type: String }];
...
var optimist = require('optimist')
  ...
  .describe(
    'loginurl',
    "Set 'monitor' to login with a specific login URL. Default: 'https://login.salesforce.com'"
  )
  .describe(
    'rec',
  ...
  return new Promise(function(resolve, reject) {
    ...
    runShellTask(
      ...
      .then(function(result) {
        ...
        console.log('mobilecaddy-angular -> ', mobilecaddyAngularVsn);
        console.log('mobilecaddy-utils -> ', mobilecaddyUtilsVsn);
        console.log('ionic-angular -> ', ionicVsn);
